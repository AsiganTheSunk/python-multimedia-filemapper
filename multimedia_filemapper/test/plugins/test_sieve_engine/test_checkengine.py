...
def test0_filemapper_check_show():
    assert check.is_show_folder('multimedia_directory_sample S01E01') is True


def test1_filemapper_check_show():
    assert check.is_show_folder('multimedia_directory_sample S00E00.mkv') is False
...
def test0_filemapper_check_season_directory():
    assert check.is_season_folder('multimedia_directory_sample Season 1') is True
...
def test3_filemapper_check_season_directory():
    assert check.is_season_folder('multimedia_directory_sample S1') is True
...
def test0_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('multimedia_main_directory_show') is True


def test1_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('multimedia_main_directory_show 1080p') is True


def test2_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('multimedia_main_directory_show Season 0') is False


def test3_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('[HorribleSubs] multimedia_main_directory_show - 10') is False


def test4_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('[HorribleSubs] multimedia_main_directory_show x10') is False


def test5_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('[HorribleSubs] multimedia_main_directory_show Episode 10') is False


def test6_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('[HorribleSubs] multimedia_main_directory_show E10') is False


def test7_filemapper_check_main_directory_show():
    assert check.is_multimedia_folder('multimedia_main_directory_show (1980)') is False
...
def test0_filemapper_check_subtitles_directory_show():
    assert check.is_show_subtitle_folder('multimedia_sample_directory S01E01 subtitle_engine') is True


def test1_filemapper_check_subtitles_directory_show():
    assert check.is_show_subtitle_folder('multimedia_sample_directory S01E01 subtitles') is True
...
def test3_filemapper_check_subtitles_directory_show():
    assert check.is_show_subtitle_folder('multimedia_sample_directory S01E01 sub') is True


def test4_filemapper_check_subtitles_directory_show():
    assert check.is_show_subtitle_folder('multimedia_sample_directory S01 sub') is False


def test5_filemapper_check_subtitles_directory_show():
    assert check.is_show_subtitle_folder('multimedia_sample_directory (1980) subtitle_engine') is False


def test6_filemapper_check_subtitles_directory_show():
    assert check.is_show_subtitle_folder('[HorribleSubs] multimedia_sample_directory subtitle_engine') is False


#Anime Directory Tests
def test0_filemapper_check_anime_directory():
    assert check.is_anime_folder('[HorribleSubs] multimedia_sample_directory - 11') is True


def test1_filemapper_check_anime_directory():
    assert check.is_anime_folder('[HorribleSubs] multimedia_sample_directory E11') is True


def test2_filemapper_check_anime_directory():
    assert check.is_anime_folder('[HorribleSubs] multimedia_sample_directory Episode 11') is True


def test3_filemapper_check_anime_directory():
    assert check.is_anime_folder('[HorribleSubs] multimedia_sample_directory x11') is True
