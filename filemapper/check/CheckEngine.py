...
class CheckEngine():
    ...
    def check_film(self, stream, verbose=False, debug=False):
        '''
        This function maps the file or directory based on the premapping done by check engine
        :param stream: It represents the input string you're mapping
        :param debug: It represents the debug status of the function, default it's False
    ...
    def check_show(self, stream, verbose=False, debug=False):
        '''
        This function maps the file or directory based on the premapping done by check engine
        :param stream: It represents the input string you're mapping
        :param debug: It represents the debug status of the function, default it's False
    ...
    def check_season_directory(self, stream, verbose=False, debug=False):
        '''
        This function maps the file or directory based on the premapping done by check engine
        :param stream: It represents the input string you're mapping
        :param debug: It represents the debug status of the function, default it's False
    ...
    def check_show_directory(self, stream, verbose=False, debug=False):
        '''
        This function maps the file or directory based on the premapping done by check engine
        :param stream: It represents the input string you're mapping
        :param debug: It represents the debug status of the function, default it's False
        ...
        try:
            ...
            if debug:
                print(
                    ...
                    stream=stream,
                    status=status,
                    unwanted_status=unwanted_status)
                print
            return status
